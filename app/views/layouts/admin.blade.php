                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span>Ricardo Tavares <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li @if ($page_title=='dashboard') {{ 'class="active"' }} @endif>
                            <a href="{{ URL::route('admin.display', 'dashboard') }}">
                                <i class="fa fa-dashboard"></i> <span>Dashboard</span>
                            </a>
                        </li>
                        <li @if ($page_title=='users') {{ 'class="active"' }} @endif>
                            <a href="{{ URL::route('admin.display', 'users') }}">
                                <i class="fa fa-users"></i> <span>Users</span>
                            </a>
                        </li>
                        <li @if ($page_title=='widgets') {{ 'class="active"' }} @endif>
                            <a href="{{ URL::route('admin.display', 'widgets') }}">
                                <i class="fa fa-th"></i> <span>Widgets</span> <small class="badge pull-right bg-green">new</small>
                            </a>
                        </li>
                        <li @if ($page_title=='calendar') {{ 'class="active"' }} @endif>
                            <a href="{{ URL::route('admin.display', 'calendar') }}">
                                <i class="fa fa-calendar"></i> <span>Calendar</span>
                                <small class="badge pull-right bg-red">3</small>
                            </a>
                        </li>
                        <li @if ($page_title=='mailbox') {{ 'class="active"' }} @endif>
